...
import { Plus, Trash2, Upload, Star, Clock, DollarSign, Package, CheckCircle2, Send, User, ShoppingBag } from "lucide-react";
...
const InfluencerDashboard = () => {
  ...
  return (
    ...
    >
      ...
      {/* SERVICES SECTION */}
      <div ref={(el) => { sectionRefs.current["services"] = el; }} className="scroll-mt-16 mb-10">
        <h2 className="text-xl font-bold mb-4">Services</h2>
        {!profile ? (
          <div className="text-center py-10"><p className="text-muted-foreground">Create your profile first before adding services.</p></div>
        ) : (
          <div className="space-y-6">
      ...
      {/* ORDERS SECTION */}
      <div ref={(el) => { sectionRefs.current["orders"] = el; }} className="scroll-mt-16">
