...
export const mockEvents: Event[] = [
  {
    ...
    ticket_types: [
      ...
      },
      {
        ...
        name: "VIP Pass",
        price: 399,
        description: "Priority seating, speaker dinner, and exclusive workshops",
        available: 23,
        max_per_order: 2,
      },
      {
    ...
    ticket_types: [
      {
        ...
        name: "Tasting Pass",
        price: 85,
        description: "Unlimited tastings from all vendors",
        available: 90,
        max_per_order: 4,
      },
      {
        ...
        price: 195,
        description: "Chef's table dinner + all tastings + wine pairing masterclass",
        available: 15,
        max_per_order: 2,
      },
    ],
    ...
    ticket_types: [
      {
        ...
        name: "Opening Night",
        price: 35,
        description: "Access to opening night reception with complimentary drinks",
        available: 44,
        max_per_order: 4,
      },
      {
  ...
  },
  {
    ...
    description:
      "A transformative morning of yoga, meditation, and mindful movement in a stunning garden setting. Led by internationally renowned wellness instructor Maya Johnson, this retreat is designed to restore balance and clarity.",
    date: "2026-04-20",
    time: "6:00 AM",
    location: "Botanical Gardens, Austin",
    ...
    ticket_types: [
      {
        ...
        name: "Single Session",
        price: 45,
        description: "One morning session with guided meditation",
        available: 15,
        max_per_order: 2,
      },
      {
        ...
        name: "Full Retreat",
        price: 120,
        description: "All sessions + organic brunch + wellness goodie bag",
        available: 8,
        max_per_order: 1,
      },
    ],
